...
const motorTableData = [
  ...
  { id: '203-COM-125B', name: 'Air Compressor-2', status: 'warning', health: 52, rul: '13 days' },
  { id: '203-P-23A', name: 'Caustic Pump-1', status: 'normal', health: 94, rul: '10 days' },
  { id: '203-P-23B', name: 'Caustic Pump-2', status: 'normal', health: 74, rul: '11 days' },
  { id: '203-EX-1', name: 'Main Exhaust Fan-1', status: 'warning', health: 78, rul: '30 days' },
  { id: '203-EX-2', name: 'Main Exhaust Fan-2', status: 'critical', health: 36, rul: '75 days' },
    ...
    <Layout>
      <div className="p-6">
        ...
        <header className="flex justify-between items-center mb-8">
          <div>
            <h2 className="text-2xl font-bold text-white">Equipment Overview</h2>
            <p className="text-slate-400">Complete motor equipment monitoring and management</p>
          </div>
